...
int main(){
  ...
  pthread_create(&hilos[2],NULL,productor,NULL);
  pthread_create(&hilos[3],NULL,productor,NULL);
  pthread_create(&hilos[4],NULL,productor,NULL);
  pthread_create(&hilos[5],NULL,consumidor,NULL);
  pthread_create(&hilos[6],NULL,consumidor,NULL);
  pthread_create(&hilos[7],NULL,consumidor,NULL);
  pthread_create(&hilos[8],NULL,consumidor,NULL);
  pthread_create(&hilos[9],NULL,consumidor,NULL);
